...
love-curse-kiss-verb = Вставить член

love-curse-kiss-start = { $user } проталкивает свой член внутрь киски...

love-curse-kiss-fail-user = Вы слишком одеты для этого.
...
love-curse-examine = [color=red]На этом персонаже висит Проклятие похоти! До разрыва на органы: { $minutes } мин. { $seconds } сек.[/color]

love-curse-panel-title = Выбор жертвы
love-curse-panel-hint = Выберите цель для наложения проклятия:
