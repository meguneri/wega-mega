...
spellbook-love-curse-name = Проклятие страсти
spellbook-love-curse-desc = Накладывает на цель проклятие. Через 30 минут жертва взорвётся — если только её не избавят страстным поцелуем без одежды.
